...
class PythonLists(unittest.TestCase):
	...
	def test_methods(self):
		...
		self.list3.pop(); self.assertEqual(self.list3, ['Google', 'Baidu', 'Runoob', 'Zoo']) #用于移除列表中的一个元素（默认最后一个元素）,并且返回该元素的值
		self.list3.pop(0); self.assertEqual(self.list3, ['Baidu', 'Runoob', 'Zoo'])
